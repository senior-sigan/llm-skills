...
- ✅ Add COMMENT to every table and field
...
- Add attributes in brackets: `[pk, increment, not null, unique, note: 'comment']`
...
- `schema-design.md` - Comprehensive database design document
- `schema.sql` - Executable SQL script
- `drawdb-schema.json` - DrawDB JSON format
- `drawdb-schema.dbml` - DrawDB DBML format
...
User says: "Design a database for an e-commerce system with user, product, and order functionality"
